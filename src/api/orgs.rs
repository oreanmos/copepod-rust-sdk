...
impl CopepodClient {
    ...
    pub async fn get_org(&self, id: &str) -> Result<Org> {
        self.get(&format!("api/orgs/{}", id)).await
    }
    ...
    pub async fn add_org_member(
        ...
        self.post(&format!("api/orgs/{}/members", org_id), body).await
    }
    ...
    pub async fn update_org_member(
        ...
        self.patch(&format!("api/orgs/{}/members/{}", org_id, user_id), body)
            .await
    }

    /// Remove a member from an organization.
    pub async fn remove_org_member(&self, org_id: &str, user_id: &str) -> Result<()> {
        self.delete(&format!("api/orgs/{}/members/{}", org_id, user_id))
            .await
    }
}
